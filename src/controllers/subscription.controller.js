...
const getUserChannelSubscribers = asyncHandler(async (req, res) => {
      ...
      return res
            .status(200)
            .json(new ApiResponse(200, { subscribers: subscribersFetched }, "Subscribers fetched successfully!"));
});
...
const getSubscribedChannels = asyncHandler(async (req, res) => {
      ...
      const subscriptionsFetched = await Subscription.find({ subscriber: req.user._id }).offset(offset).limit(limit);
